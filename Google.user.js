...
(function() {
  ...
  const openInterval = 20,
        ...
        imgCalendar = 'data:image/png;base64,',
  ...
  function dateTimeFormat(int) {
    ...
    switch (int) {
      ...
      case 1: return ww + comma + space + mmmm + space + ddd + comma + space + yyyy + space + clock + space + hr12 + min + sec + space + ampm; // Sunday ?? March 1st, 2021 ?? 12:34 AM
